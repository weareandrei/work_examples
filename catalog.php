        ...
        <div class="breadcrubms">
            <ul>
                ...
                <?php
                    ...
                    $sql_cat = "SELECT * FROM `available_categories` WHERE Category_ID='$cat_ID'";
                    $query = mysqli_query($connection,$sql_cat);
                    ...
                    if ($sub_cat != 'all') {
                        $sql = "SELECT * FROM `available_sub_categories` WHERE `Sub_Category_ID`='$sub_cat'";
                                     ...
                                     <a class="more" href="#">Категории</a>
                                        <div class="catalog-filter-more-box catalog-category" id="cat-filter-box">
                                            <div class="custom-scrollbar">
                                                ...
                                                ';
                                                $cat = $_GET['category'];
                                                $sql = "SELECT * FROM `available_sub_categories` WHERE (`Category_ID`='$cat')";
                                                $query = mysqli_query($connection, $sql);
                                                while($row = mysqli_fetch_assoc($query)) {
                                                    $sub_cat_name = $row['Title'];
                                                    $sub_cat_id = $row['Sub_Category_ID'];
                                                    echo '
                                                    <li>
                                                        <input type="checkbox" id="filter-'.$sub_cat_name.'-male" class="filter-tag"
                                                            data-filter-type="categories"
                                                            data-cat-id="'.$sub_cat_id.'"
                                                            data-cat-main="'.$cat.'"
                                                            data-gender="b">
                                                        <label for="filter-'.$sub_cat_name.'-male">'.$sub_cat_name.'</label>
                                                    </li>
                                                    ';
                                                }
                                                echo '
